...
export const goalTypeConfigs: Record<
  GoalType,
  {
    icon: LucideIcon
    label: string
      ...
      <CardContent className="p-4 space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-xs text-[#6b7280]">
            <span>
              {goal.startValue && `${goal.startValue} ${goal.unit} →`}{' '}
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm" style={{ color: progressColor }}>
        ...
        {goal.exerciseId && (
          <Badge
            variant="outline"
            className="rounded-lg text-xs border-[#e5e7eb]"
          >
